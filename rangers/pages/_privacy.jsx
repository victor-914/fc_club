...
function Privacypolicy() {
  return (
    <StyledPolicy>
      <header id="main">Privacy Policy</header>
      <p>
        Our privacy policy will help you understand what information we collect
        at Rangers International Football Club, how Rangers International
        Football Club uses it, and what choices you have. Rangers International
        Football Club built the Rangers Int’l FC app as a free app.
      </p>
      <p>
        This <b>SERVICE</b> is provided by{" "}
        <b>Rangers International Football Club</b> at no cost and is intended
        for use as is. If you choose to use our Service, then you agree to the
      ...
      <p>
        ...
        personally identifiable information, including but not limited to users
        name, email address, gender, location.
      </p>
      <p>
      ...
      <p>
        ...
        use some portions of this Service. Location Information Some of the
        services may use location information transmitted from users' mobile
        phones.
      </p>
      <p>
        We only use this information within the scope necessary for the
        designated service. Device Information We collect information from your
        device in some cases. The information will be utilised for the provision
        of better service and to prevent fraudulent acts. Additionally, such
        information will not include that which will identify the individual
        user.
      </p>
      <p>
      ...
      <p>
        ...
        <p>
          ...
          cannot guarantee its absolute security. If you wish to be informed
          what Personal Data we hold about you and if you want it to be removed
          from our systems, please email us at
        </p>
        <a>info@rangersintl.com.</a>
      </p>
      <p>
        ...
        be able to do necessary actions. Changes to This Privacy Policy We may
        ...
        Us If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us.
        <header>Contact Information:</header> Email: info@rangersintl.com
      </p>
    </StyledPolicy>
  );
}
...
const StyledPolicy = styled.section`
  width: 50%;
  padding-top: 12.2vh;
  margin: auto;
  text-align: justify;
